(function($){
    ...
    self.bsSlide = function( $slide ){
        ...
        var $elem,                  // slider
            ...
            $elemList,              // slide li
            $elemListLnk,           // slide a
            $elemIndi,              // slide indibox
            $elemPager,             // slide indi pager
        ...
        function directMove(){
            var moveX;
            var pageridx = $elemPager.index(this);
            thisidx = pageridx;
            moveX = pageridx * moveWidth;
        ...
        function moveElem( moveX ){
            ...
            //bs-indi(number)
            $('.popnum .curjs').text(thisidx + 1);
            $('.popnum .totjs').text($elemList.length);

            //bs-indi
            $elemPager.removeClass('active');
            $elemPager.eq(thisidx).addClass('active');
        }
        ...
        self.controlSet = function( basicobj ){
            $elem = $slide,
                ...
                $elemIndi = $('.bs-indibox'),
                $elemPager = $elemIndi.find('.bs-pager'),
        ...
        function deviceLen ( arr ) {
            ...
            switch(CCS.IS_VIEWTYPE) {
                case 'web':
                    checkDeviceLen = arr[0]; //pc 보이는 개수
                    break;
                case 'tablet':
                    checkDeviceLen = arr[0]; //tablet 보이는 개수
                    break;
                case 'mobile':
                    checkDeviceLen = arr[0]; //mobile 보이는 개수
                    break;
            }
